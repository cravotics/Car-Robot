...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'racecar_1.urdf'
    xacro_file = "racecar_1.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "racecar_1"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("racecar_1"), "rviz", "display_default.rviz"]
    )
